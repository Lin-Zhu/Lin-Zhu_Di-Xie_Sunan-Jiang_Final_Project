	...
	<div class = "navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-header">
			...
			<div class = "collapse navbar-collapse navHeaderCollapse">
				...
				<li><a href = "#"><font color="white">Photos</font></a></li>
...
<div class="box">
    ...
    <div class="basicInfo" id="basic" style="display: block">
			<span style="width: 100%; float: left; display: block; font-family: Verdana, Geneva, sans-serif"> <label for="basicInfo" style="font-size: 35px">Friends</label>
		     	  <span style="float:right"><input  type="button" value="add friends" /></span>
			</span><br />
		    <span style="width:100%"><input name="nickname" style="display:inline" /><input  type="button" value="search" /></span><br/> 
		    <div class="friendslist">
		    	<ul class="friends" >
				    <li id="friend1" style="list-style-type: none; font-family: 'Comic Sans MS', cursive; margin: 10px; dispaly:block"> Friend1 <input style="float:right; height:30px"  type="button" value="delete" /></li>
				    <li id="friend2" style="list-style-type: none; font-family: 'Comic Sans MS', cursive; margin: 10px; dispaly:block"> Friend2 <input style="float:right; height:30px"  type="button" value="delete" /></li>
				    <li id="friend3" style="list-style-type: none; font-family: 'Comic Sans MS', cursive; margin: 10px; dispaly:block"> Friend3 <input style="float:right; height:30px"  type="button" value="delete" /></li>
				    <li id="friend4" style="list-style-type: none; font-family: 'Comic Sans MS', cursive; margin: 10px; dispaly:block"> Friend4 <input style="float:right; height:30px"  type="button" value="delete" /></li>
				    <li id="friend5" style="list-style-type: none; font-family: 'Comic Sans MS', cursive; margin: 10px; dispaly:block"> Friend5 <input style="float:right; height:30px"  type="button" value="delete" /></li>		    
				</ul>
		    </div>	  
	<dir></dir>
